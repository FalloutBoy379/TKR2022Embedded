...
int upPin = 9;               //8                  //Throwing Mechanism
int dpPin = 10;               //9
int dForward = 42;
int dBackward = 43;
int uForward = 40;
...
#define pistonCenterOut 32  //28                    //Hopper Mechanism
#define pistonCenterIn 30   //29
#define pistonLeft 26       //30
#define pistonRight 28     //31
