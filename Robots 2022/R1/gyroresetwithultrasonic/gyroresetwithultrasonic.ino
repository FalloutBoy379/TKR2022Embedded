...
////////////////////////////
float distance1, distance2, dif, x = 33.8, jugaad = 0, angzultrasonic;
int a = 0;
///////////////////////////////////////////////////////////////////////////////////////////
...
double ultrasonic()
{
  ...
  angzultrasonic = atan2(dif, x);
  angzultrasonic = (angzultrasonic * 180 * 7) / 22;
  return (angzultrasonic);
...
void loop()                                                                                              // Code which has to be on loop
{
  ...
  mpu.update();
  int sudhaar = PID_drive(mpu.getAngleZ() - jugaad, targetGyroAngle_drive);
  drive(0, 0, sudhaar);
  /*____________________________________________________________________________________________________*/
  ...
  else if (buttonCount_throwing % 2 == 0 && buttonCount_throwing != 0)
  {
    ...
    jugaad = ultrasonic() - mpu.getAngleZ();

    if(jugaad<=5 && jugaad>=-5)
    {
      jugaad = 0;
    }
    //digitalWrite(gyroSwitch1,HIGH);
