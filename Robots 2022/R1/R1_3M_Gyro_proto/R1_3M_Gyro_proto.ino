...
int upPin = 5;               //8                  //Throwing Mechanism
int dpPin = 6;               //9
int dForward = 43;
int dBackward = 42;
int uForward = 41;
...
#define pistonCenterOut 50  //28                    //Hopper Mechanism
#define pistonCenterIn 51   //29
#define pistonLeft 52       //30
#define pistonRight 53      //31
#define motorLeftA 13       //26
#define motorLeftB 9
#define motorRightA 22      //27
...
bool ps_read() {
  ...
  if (butt[PS_L1] == 1)
  {
    target_gyro += 5;                                  //Bot rotation by increasing target value
    Serial.println("L1");
    butt[PS_L1] = 0;
  }
  if (butt[PS_R1] == 1)
  {
    target_gyro -= 5;                                  //Bot rotation by decreasing target value
    Serial.println("R1");
    butt[PS_R1] = 0;
  }
  if (butt[PS_L2] == 1)
...
void delay_ms(long int ms) {                             //Delay by millis
