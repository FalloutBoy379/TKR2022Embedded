...
BTS M1(M1PWM , M1DIR1 , M1DIR2), M2(M2PWM , M2DIR1 , M2DIR2), M3(M3PWM , M3DIR2 , M3DIR1), PW(PWPWM , PWDIR1 , PWDIR2);
...
///////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////
void lights_write(int red, int green, int blue) {
...
void lights_decider()
{
  if (leftPiston_Flag == 1 || rightPiston_Flag == 1 || centrePiston_Flag == 1)
  {
    r = 0;
    g = 255;
    b = 255;
  ...
  if(Raftaar == 0 && leftPiston_Flag == 0 && rightPiston_Flag == 0 && centrePiston_Flag == 0)
  {
    r = 0;
    b = 0;
    g = 255;
...
void setup()
{
  ...
  lights_setup();
  Serial.println("Lights setup done");
  lights_write(255, 255, 255);
